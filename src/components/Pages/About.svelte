<div class="about-page" id="about">
	<div>
		...
		<div class="text-md text-off-gray" style="padding: 200px">
			<p>
				...
				working in a fast moving team-based environment. Experience in:
			</p>
			<ul class="font-mono text-xs xs:text-sm" style="column-count:3">
				<li>Typescript with Node and React</li>
